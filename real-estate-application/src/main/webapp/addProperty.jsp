...
<body>
    ...
    <form action="sell" method="POST">
        ...
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" placeholder="Enter the dimensions of the property"
                    name="dimensions" id="dimensions" required>
                <span></span>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <input type="number" class="form-control" placeholder="Enter the base value for the property in INR"
                    name="propertyValue" id="propertyValue">
                <span id="emailErr" class="msg"></span>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" placeholder="Enter exact location of the property"
