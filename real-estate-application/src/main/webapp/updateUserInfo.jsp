                    ...
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="User First name" name="userFirstName"
                                id="userFirstName" value="${user.getUserFirstName()}" required>
                            <span></span>
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Last Name" name="userLastName"
                                id="userLastName" value="${user.getUserLastName()}" required>
                            <span></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Email Id" name="userEmailId"
                                id="userEmailId" onchange="verifyEmail()" value="${user.getUserEmailId()}">
                        ...
                        <div class="col">
                            <input type="number" class="form-control" placeholder="Phone number" name="userPhoneNumber"
                                ...
                                onchange="verifyPhone()" value="${user.getUserPhoneNumber()}">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Current Address"
                                ...
                                value="${user.getUserCurrentAddress()}">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Permanent Address"
                                ...
                                onchange="verifyPermanentAddress(this)" value="${user.getUserPermanentAddress()}">
