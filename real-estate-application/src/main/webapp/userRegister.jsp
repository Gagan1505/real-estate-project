...
<body>
    ...
    <div class="form">
        <form action="register" method="POST" style="margin-top:120px; width: 60vw;border: 1px solid green;padding: 20px;border-radius: 10px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
            ...
            <div class="row">
              <div class="col">
                <input type="text" class="form-control" placeholder="User First name" name="userFirstName" id="userFirstName" required>
                <span></span>
              </div>
              <div class="col">
            ...
            <div class="row">
                <div class="col">
                  <input type="text" class="form-control" placeholder="Email Id" name="userEmailId" id="userEmailId" onchange="verifyEmail()" >
                  <span id="emailErr" class="msg"></span>
                </div>
                <div class="col">
                  <input type="number" class="form-control" placeholder="Phone number" name="userPhoneNumber" id="userPhoneNumber" maxlength="10" oninput="limitDigits(this,10)" onchange="verifyPhone()">
                  <span id="phoneError"  class="msg"></span>
                </div>
            </div>
            <div class="row">
                <div class="col">
                  <input type="number" class="form-control" placeholder="Adhaar number" name="userAdhaar" id="userAdhaar" maxlength="12" oninput="limitDigits(this,12)" onchange="verifyAdhaar()">
                  <span id="adhaarError"  class="msg"></span>
                </div>
                <div class="col">
                  <input type="text" class="form-control" placeholder="PAN number" name="userPanCard" id="userPanCard" maxlength="10" onchange="verifyPanCard()" >
                  <span id="panError"  class="msg"></span>
                </div>
            </div>
            <div class="row">
                <div class="col">
                  <input type="text" class="form-control" placeholder="Current Address" name="userCurrentAddress" id="userCurrentAddress" onchange="verifyCurrentAddress(this)" >
                  <span id="currentErr" class="msg"></span>
                </div>
                <div class="col">
                  <input type="text" class="form-control" placeholder="Permanent Address" name="userPermanentAddress" id="userPermanentAddress" onchange="verifyPermanentAddress(this)" >
                  <span id="permanentErr" class="msg"></span>
                </div>
            </div>
            <div class="row">
                <div class="col">
                  <input type="password" class="form-control" placeholder="Password" name="userPassword" id="userPassword" onchange="verifyPassword(this)">
                  <span id="passwordError" class="msg"></span>
                </div>
                <div class="col">
                  <input type="password" class="form-control" placeholder="Confirm Password" id="confirmPassword" onchange="confrmPassword(this)">
                  <span id="cnfrmPswd" class="msg"></span>
                </div>
            </div>
            <div class="row">
                <div class="col">
                  <input type="submit" class="form-control btn btn-success" id="register" value="Register" >
                </div>
                <div class="col">
    ...
    <script>
        ...
        function enableRegister(key,value){
            if(key || value){
                ...
                if(enableButton && Object.keys(valid).length == 8){
        ...
        function verifyPassword(pd){
        console.log(pd.value);
            let pwdError = document.getElementById("passwordError");
            if(pd.value.length < 3){
                pwdError.innerHTML = "Password must contain at-least 3 characters";
                enableRegister("password",false);
            }else{
                 pwdError.innerHTML = "";
                 enableRegister("password",true);
            }
        }


        function confrmPassword(pwd){
            let password = document.getElementById("userPassword");
            let cnfrmErr = document.getElementById("cnfrmPswd");
            console.log(pwd.value,password.value);
            if(pwd.value == password.value){
                cnfrmErr.innerHTML = "";
                enableRegister("confirmPassword",true);
            }else{
                cnfrmErr.innerHTML = "password does'nt match";
                enableRegister("confirmPassword",false);
            }
        }
